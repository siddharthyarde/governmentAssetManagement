...
export const metadata: Metadata = {
  title: "Sign In — GAMS Supplier Portal",
    ...
    <div className="min-h-dvh bg-surface flex flex-col">
      ...
      <header className="bg-white border-b border-border px-6 py-3 flex items-center gap-3">
        ...
        <nav className="ml-auto flex gap-4 text-sm">
          <a href="/company/login" className="text-muted-foreground hover:text-foreground transition-colors">
            Sign In
          </a>
          <a href="/company/register" className="text-primary font-medium hover:underline">
            Register Company
          </a>
        </nav>
      </header>
