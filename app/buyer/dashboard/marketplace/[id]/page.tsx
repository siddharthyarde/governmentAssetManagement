    ...
    <div className="min-h-dvh bg-surface flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-20 bg-white border-b border-border px-4 md:px-6 py-3 flex items-center gap-4 shrink-0">
          <Link href="/buyer/dashboard/marketplace" className="p-2 rounded-lg border border-border hover:bg-surface">
            <ArrowLeft size={16} />
          </Link>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1 text-xs text-gray-400 flex-wrap">
              <Link href="/buyer/dashboard/marketplace" className="hover:underline">Marketplace</Link>
          ...
          {ordered && (
            <div className="mb-5 bg-green-50 border border-green-200 rounded-2xl p-4 flex gap-3">
              ...
              <div>
                ...
                <Link href="/buyer/dashboard/orders" className="inline-flex items-center gap-1 mt-2 text-xs font-bold text-green-700 hover:underline">
                  View my orders →
                </Link>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="bg-white border border-border rounded-2xl p-5">
                ...
                <div className="flex flex-col gap-2">
                  <Link href="/buyer/dashboard/marketplace" className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-border text-sm font-semibold text-gray-700 hover:bg-surface">
                    <ShoppingBag size={13} className="text-gray-400" /> Browse All Listings
                  </Link>
                  <Link href="/buyer/dashboard/orders" className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-border text-sm font-semibold text-gray-700 hover:bg-surface">
                    <ClipboardList size={13} className="text-gray-400" /> My Orders
                  </Link>
                  <Link href="/buyer/dashboard/documents" className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-border text-sm font-semibold text-gray-700 hover:bg-surface">
