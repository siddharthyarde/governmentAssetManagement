    ...
    <div className="min-h-dvh bg-surface">
      ...
      <div className="bg-white border-b border-border sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 flex items-center gap-3">
          <Link href="/buyer/dashboard" className="p-2 rounded-xl border border-border hover:bg-surface text-gray-400 hover:text-gray-700 transition-colors">
            <ArrowLeft size={16} />
          </Link>
          <div>
            <h1 className="text-base font-bold text-gray-900">My Orders</h1>
            <div className="flex items-center gap-1 text-xs text-gray-400 mt-0.5">
              <Link href="/buyer/dashboard" className="hover:text-gray-700">Dashboard</Link>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 flex flex-col gap-5">
        ...
        {filtered.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center bg-white border border-border rounded-2xl">
            ...
            <Link href="/buyer/dashboard/marketplace" className="text-white text-sm font-bold px-5 py-2.5 rounded-xl hover:opacity-90" style={{ background: "#138808" }}>
              Go to Marketplace
            </Link>
          </div>
        )}
