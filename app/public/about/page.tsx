        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/public/marketplace" className="inline-flex items-center gap-2 text-white font-bold px-5 py-2.5 rounded-xl bg-saffron-500 hover:bg-saffron-600 text-sm">
                Browse Marketplace <ArrowRight size={15} />
              </Link>
              <Link href="/public/register" className="inline-flex items-center gap-2 text-saffron-700 font-bold px-5 py-2.5 rounded-xl border border-saffron-300 bg-saffron-50 hover:bg-saffron-100 text-sm">
      ...
      <section className="py-12 bg-saffron-500">
        <div className="max-w-screen-xl mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link href="/public/register" className="bg-white text-saffron-600 font-bold px-6 py-2.5 rounded-xl hover:bg-saffron-50 text-sm">Register Institution →</Link>
            <Link href="/public/marketplace" className="bg-saffron-700 text-white font-bold px-6 py-2.5 rounded-xl hover:bg-saffron-800 text-sm">Browse Marketplace</Link>
          </div>
        </div>
      </section>
