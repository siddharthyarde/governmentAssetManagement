      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between py-3 gap-4">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-700">
            <Link href="/public/marketplace" className="text-saffron-600 font-semibold">Marketplace</Link>
            <Link href="/how-it-works" className="hover:text-saffron-600 transition-colors">How It Works</Link>
            <Link href="/public/about" className="hover:text-saffron-600 transition-colors">About GAMS</Link>
          </nav>

          <div className="flex items-center gap-3">
            <Link href="/public/login" className="hidden sm:flex items-center gap-1.5 text-sm font-semibold text-saffron-700 border border-saffron-300 rounded px-3 py-1.5 hover:bg-saffron-50 transition-colors">
              <LogIn size={14} /> Login
            </Link>
            <Link href="/public/register" className="flex items-center gap-2 text-sm font-bold text-white rounded px-4 py-1.5" style={{ background: "#E07B00" }}>
        ...
        {mobileOpen && (
          <nav className="md:hidden border-t border-border py-3 flex flex-col gap-3 text-sm font-medium">
            ...
            <Link href="/public/about" className="text-gray-700">About GAMS</Link>
            <Link href="/public/login" className="text-gray-700">Login</Link>
          </nav>
        )}
      </div>
    </header>
            ...
            <div className="mt-8 flex items-start gap-4 border border-blue-200 bg-blue-50 rounded-2xl px-6 py-5">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  ...
                  <Link href="/public/register" className="font-semibold underline underline-offset-2 hover:text-blue-900">
