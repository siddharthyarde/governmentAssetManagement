    ...
    <div className="min-h-dvh bg-surface flex">
      ...
      <aside className="hidden md:flex flex-col w-52 bg-white border-r border-border shrink-0">
        ...
        <nav className="flex-1 py-3 px-3 flex flex-col gap-0.5">
          <Link href="/manage" className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-semibold text-gray-500 hover:bg-surface">
            <LayoutDashboard size={15} /> Dashboard
          </Link>
          <Link href="/manage/approvals" className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-semibold text-gray-500 hover:bg-surface">
            <CheckCircle2 size={15} /> Approvals
          </Link>
          <Link href="/manage/events" className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-semibold text-gray-500 hover:bg-surface">
            <Calendar size={15} /> Events
          </Link>
          <Link href="/manage/analytics" className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-semibold text-gray-500 hover:bg-surface">
            <FileText size={15} /> Analytics
          </Link>
          <Link href="/manage/users" className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-bold bg-saffron-50 text-saffron-700">
