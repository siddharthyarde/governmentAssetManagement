      ...
      <div className="bg-white border-b border-border sticky top-0 z-20">
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 flex items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            <Link href="/dashboard/products" className="flex items-center gap-1.5 border border-border rounded-xl px-3 py-2 text-xs font-semibold text-gray-600 hover:bg-surface">
