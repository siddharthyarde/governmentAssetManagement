            ...
            <div className="relative">
              ...
              {userMenuOpen && (
                <div className="absolute right-0 top-full mt-1 w-48 bg-white border border-border rounded-xl shadow-lg z-50 py-1">
                  <Link href="/dashboard/settings" className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-surface">
            ...
            <div className="mb-6 rounded-2xl border border-yellow-200 bg-yellow-50 p-5 flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2">
                  <Link href="/dashboard/documents" className="inline-flex items-center gap-1.5 text-xs font-bold bg-yellow-600 text-white px-3 py-1.5 rounded-lg hover:bg-yellow-700 transition-colors">
          ...
          {companyStatus === "rejected" && (
            <div className="mb-6 rounded-2xl border border-red-200 bg-red-50 p-5 flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <Link href="/dashboard/documents" className="inline-flex items-center gap-1.5 text-xs font-bold bg-red-600 text-white px-3 py-1.5 rounded-lg hover:bg-red-700 transition-colors">
          ...
          <div className="grid lg:grid-cols-5 gap-4 mb-4">
            ...
            <div className="lg:col-span-2 bg-white border border-border rounded-2xl overflow-hidden">
              <div className="flex items-center justify-between px-5 py-4 border-b border-border">
                ...
                <Link href="/dashboard/orders" className="text-xs font-semibold text-saffron-600 hover:text-saffron-700 flex items-center gap-1">
                  View All <ChevronRight size={12} />
                </Link>
              </div>
