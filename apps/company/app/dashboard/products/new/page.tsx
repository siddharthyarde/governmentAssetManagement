      ...
      <div className="min-h-dvh bg-surface flex items-center justify-center p-6">
        <div className="bg-white border border-border rounded-2xl p-10 max-w-md w-full text-center shadow-sm">
          ...
          <div className="flex flex-col gap-2">
            <Link href="/dashboard/products" className="inline-flex items-center justify-center gap-2 text-sm font-bold text-white py-2.5 rounded-xl" style={{ background: "#E07B00" }}>
    ...
    <div className="min-h-dvh bg-surface">
      ...
      <div className="bg-white border-b border-border sticky top-0 z-20">
        <div className="max-w-3xl mx-auto px-4 md:px-6 py-4 flex items-center gap-3">
          <Link href="/dashboard/products" className="p-2 rounded-xl border border-border hover:bg-surface transition-colors text-gray-400 hover:text-gray-700">
            <ArrowLeft size={16} />
          </Link>
          <div>
