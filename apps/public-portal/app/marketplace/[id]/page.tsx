    ...
    return (
      <div className="min-h-dvh bg-surface flex items-center justify-center p-6">
        <div className="bg-white border border-border rounded-2xl p-10 flex flex-col items-center gap-4 text-center max-w-sm w-full">
          ...
          <Link href="/marketplace" className="text-sm font-bold text-white px-6 py-2.5 rounded-xl" style={{ background: "#E07B00" }}>
            Back to Marketplace
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-dvh bg-surface">
      ...
      <header className="bg-white border-b border-border sticky top-0 z-30">
        <div className="max-w-screen-xl mx-auto px-4 md:px-6 py-3 flex items-center gap-3">
          <Link href="/marketplace" className="p-2 rounded-xl border border-border hover:bg-surface transition-colors text-gray-400 hover:text-gray-700">
            <ArrowLeft size={16} />
          </Link>
