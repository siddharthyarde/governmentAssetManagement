      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-6">
        ...
        <div className="flex items-center justify-between py-3 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/login" className="hidden sm:flex btn-outline text-sm">
...
function StatTicker() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      db.from("redistribution_listings").select("*", { count: "exact", head: true }).in("status", ["dispatched", "delivered"]),
      ...
      <div className="relative max-w-screen-xl mx-auto px-4 md:px-6 py-16 md:py-24">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/register" className="btn-outline text-base px-7 py-3">
              Create Free Account
            </Link>
          </div>
...
function ProductCard({
  ...
  return (
    <div className="bento-card group overflow-hidden p-0 flex flex-col">
      ...
      <div className={`h-44 ${imageGradient} flex items-end p-4 relative shrink-0`}>
        {/* Discount badge */}
    ...
    <section className="py-16 bg-white">
      <div className="max-w-screen-xl mx-auto px-4 md:px-6">
        <div className="flex items-end justify-between mb-8">
          ...
          <Link href="/marketplace" className="text-sm text-saffron-600 hover:underline flex items-center gap-1 font-semibold">
...
const SAMPLE_PRODUCTS = [
  {
    name: "Samsung 1.5 Ton Inverter Air Conditioner",
    category: "Appliances",
    originalPrice: 38000,
    listingPrice: 13300,
    rating: 8 as const,
    ...
    id: "GOI-DLH001-R-APPL-2024-00002841",
    imageGradient: "bg-gradient-to-br from-[#F0F4F8] to-[#D9E2EC]",
  },
  {
    name: "Heavy Duty Steel Conference Table (8-Seater)",
    category: "Furniture",
    originalPrice: 22000,
    listingPrice: 7700,
    rating: 7 as const,
    stock: 8,
    condition: "Used — Good",
    company: "FurnCraft Industries Pvt Ltd",
    id: "GOI-MHT003-R-FURN-2023-00001142",
    imageGradient: "bg-gradient-to-br from-[#F5F0E8] to-[#E8D5B0]",
  },
  {
    name: "Godrej Executive Ergonomic Office Chair",
    category: "Furniture",
    originalPrice: 12500,
    listingPrice: 4375,
    rating: 8 as const,
    ...
    id: "GOI-KAR002-R-FURN-2024-00008823",
    imageGradient: "bg-gradient-to-br from-[#EDF7ED] to-[#C8E6C9]",
  },
  {
    name: "Poly Cotton Stage Backdrop Banner (10×20 ft)",
    category: "Textiles",
    originalPrice: 8500,
    listingPrice: 4250,
    rating: 10 as const,
    ...
    id: "GOI-TNA005-R-TEXT-2025-00000384",
    imageGradient: "bg-gradient-to-br from-[#FFF3E0] to-[#FFCC80]",
  },
  {
    name: "Dell OptiPlex 7010 Desktop Computer",
    ...
    id: "GOI-DLH004-R-ELEC-2023-00004510",
    imageGradient: "bg-gradient-to-br from-[#EDE7F6] to-[#C5CAE9]",
  },
  {
    name: "Borosil Stainless Catering Set (50-piece)",
    category: "Appliances",
    originalPrice: 15000,
    listingPrice: 5250,
    rating: 9 as const,
    stock: 3,
    condition: "Unused — Minor Defect",
    company: "Borosil Ltd.",
    id: "GOI-MHT001-R-APPL-2025-00000021",
    imageGradient: "bg-gradient-to-br from-[#F3F3F3] to-[#DCDCDC]",
  },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            {["Browse All Products", "Electronics", "Furniture", "Vehicles", "Medical Equipment"].map((l) => (
              <Link key={l} href="/marketplace" className="block text-xs text-[#C0C0B8] hover:text-white py-1 transition-colors">{l}</Link>
            ))}
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 md:px-6">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link href="/marketplace" className="text-sm text-saffron-600 hover:underline flex items-center gap-1 font-semibold shrink-0">
      ...
      <section className="py-14 bg-saffron-500">
        <div className="max-w-screen-xl mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link href="/register" className="bg-white text-saffron-700 font-bold px-7 py-3 rounded-xl hover:bg-saffron-50 transition-colors text-sm">
              Create Free Account
            </Link>
            <Link href="/marketplace" className="border-2 border-white text-white font-bold px-7 py-3 rounded-xl hover:bg-saffron-600 transition-colors text-sm">
