        ...
        <header className="sticky top-0 z-20 bg-white border-b border-border">
          ...
          <div className="px-4 md:px-6 py-3 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <Link href="/scan" className="btn-primary gap-2 text-sm">
                <Scan size={16} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bento-card md:col-span-2">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/audit" className="text-xs text-saffron-600 hover:underline flex items-center gap-1">
            ...
            <div className="bento-card flex flex-col gap-3">
              ...
              <Link href="/companies?status=pending" className="flex items-center justify-between p-3 rounded-xl bg-saffron-50 hover:bg-saffron-100 transition-colors group">
                <div className="flex items-center gap-3">
              ...
              <Link href="/institutions?status=pending" className="flex items-center justify-between p-3 rounded-xl bg-green-50 hover:bg-green-100 transition-colors group">
                <div className="flex items-center gap-3">
              ...
              <Link href="/assets?status=pending_approval" className="flex items-center justify-between p-3 rounded-xl bg-gold-50 hover:bg-gold-100 transition-colors group">
                <div className="flex items-center gap-3">
              ...
              <Link href="/defects?status=open" className="flex items-center justify-between p-3 rounded-xl bg-red-50 hover:bg-red-100 transition-colors group">
                <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bento-card">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/events" className="text-xs text-saffron-600 hover:underline flex items-center gap-1">
