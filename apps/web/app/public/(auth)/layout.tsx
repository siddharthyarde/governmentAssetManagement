  ...
  return (
    <div className="min-h-dvh bg-surface flex flex-col">
      ...
      <header className="bg-white border-b border-border px-4 py-3 flex items-center gap-3">
        <Link href="/public" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
        ...
        <nav className="ml-auto flex gap-4 text-sm">
          <Link href="/public/login" className="text-muted-foreground hover:text-foreground transition-colors">
            Sign In
          </Link>
          <Link href="/public/register" className="text-primary font-medium hover:underline">
            Register
          </Link>
        </nav>
      </header>
